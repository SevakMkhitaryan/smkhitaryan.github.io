...
trace1=go.Bar(x=[15,50,15,20],y=["x8","x7","x6","x5"],orientation = 'h',marker=dict(color="red"),name="Negative")
trace2=go.Bar(x=[-15,-45,-5,-35],y=["x4","x3","x2","x1"],orientation = 'h',marker=dict(color="blue"),name="Positive")
...
#Graph 2
import quandl
quandl.ApiConfig.api_key = "dgLtYf5G1Jxn4UjtW4mC"
...
goog_4=goog.loc[1:4]
goog_1pc=round(goog_4["Open"][1],3) #first percentage change 
goog_2pc=round(goog_4["Open"][2],3) #second percentage change 
goog_3pc=round(goog_4["Open"][3],3) #third percentage change 
goog_4pc=round(goog_4["Open"][4],3) #fourth percentage change 
...
bit_4=bit.loc[1:4]
bit_1pc=round(bit_4["Open"][1],3) #first percentage change 
bit_2pc=round(bit_4["Open"][2],3) #second percentage change 
bit_3pc=round(bit_4["Open"][3],3) #third percentage change 
bit_4pc=round(bit_4["Open"][4],3) #fourth percentage change 
